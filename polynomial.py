...
class Polynomial:
    ...
    def __init__(self, polyDict):
        ...
        """
        assert all(
            isinstance(k, int) and isinstance(v, int) for k, v in polyDict.items()
        ), "Check all the powers and coeffs are integer or not."
    ...
    def __mul__(self, other):
        assert isinstance(other, Polynomial) or isinstance(
            other, int
        ), "Only integer or polynomial class operations are allowed."
